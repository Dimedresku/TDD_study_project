...
class ItemFormTest(TestCase):
    ...
    def test_form_validation_for_blank_items(self):
        '''test validation for blank elements'''
...
class ExistingListItemFormTest(TestCase):
    '''test form for element existing lists'''
    ...
    def test_form_validation_for_blank_items(self):
        '''test: validation form for blank items'''
        list_ = List.objects.create()
    ...
    def test_form_validation_for_duplicate_items(self):
        '''test: validation form for duplicate items'''
        list_ = List.objects.create()
...
class NewListFormTest(unittest.TestCase):
    ...
    def tets_save_creates_new_list_form_post_data_if_user_not_authenticated(
